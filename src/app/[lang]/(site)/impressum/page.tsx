...
export default function ImpressumPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const sections: Array<{ title: string; body: string }> = [
    { title: i.sections.provider, body: i.sections.providerBody },
    { title: i.sections.contact, body: i.sections.contactBody },
    { title: i.sections.management, body: i.sections.managementBody },
    { title: i.sections.register, body: i.sections.registerBody },
    { title: i.sections.vat, body: i.sections.vatBody },
    { title: i.sections.responsible, body: i.sections.responsibleBody },
    { title: i.sections.disclaimer, body: i.sections.disclaimerBody },
  ];
  ...
  return (
    <div style={{ background: "#f5f5f7", minHeight: "60vh", padding: "80px 0" }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 clamp(16px,3vw,48px)" }}>
        ...
        <h1 style={{ fontSize: "clamp(1.6rem,2.8vw,2.4rem)", fontWeight: 800, letterSpacing: "-0.03em", color: "#1d1d1f", marginBottom: 48, lineHeight: 1.15 }}>{i.title}</h1>
