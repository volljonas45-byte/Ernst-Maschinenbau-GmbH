          ...
          <div style={{ display: "grid", gridTemplateColumns: "3fr 2fr", gap: 32, alignItems: "start" }} className="two-col-stack">
              ...
              <form style={{ display: "flex", flexDirection: "column", gap: 18 }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }} className="two-col-stack">
                  <div>
                    ...
                    <input type="text" style={inputStyle} placeholder="Ihr Name"
                      onFocus={e => { (e.target as HTMLElement).style.borderColor = "#1a8a3c"; (e.target as HTMLElement).style.boxShadow = "0 0 0 3px rgba(26,138,60,0.1)"; }}
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
                  ...
                  <button type="submit" style={{
                    ...
                    boxShadow: "0 4px 16px rgba(26,138,60,0.3)",
            ...
            <div className="reveal-right" style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div style={{ background: "#0c1a30", borderRadius: 20, padding: "32px", color: "#fff" }}>
                <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#22c55e", marginBottom: 16 }}>Anschrift</p>
                ...
                <div style={{ marginTop: 20, display: "flex", flexDirection: "column", gap: 10 }}>
                  <a href="tel:+4972639199-0" style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 14, color: "rgba(255,255,255,0.8)", textDecoration: "none" }}>
                    <div style={{ width: 32, height: 32, borderRadius: 8, background: "rgba(26,138,60,0.2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <svg width="14" height="14" fill="none" stroke="#22c55e" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                    </div>
                    +49 (0)7263 / 9199-0
                  </a>
                  ...
                  <a href="mailto:info@ernstmaschinen.de" style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 14, color: "rgba(255,255,255,0.8)", textDecoration: "none" }}>
                    <div style={{ width: 32, height: 32, borderRadius: 8, background: "rgba(26,138,60,0.2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <svg width="14" height="14" fill="none" stroke="#22c55e" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    </div>
              ...
              <div style={{ background: "#fff", borderRadius: 20, padding: "28px", border: "1px solid rgba(0,0,0,0.06)", boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
                <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "#1a8a3c", marginBottom: 20 }}>Direkte Ansprechpartner</p>
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  {[
                    ...
                    <div key={p.name} style={{ display: "flex", alignItems: "center", gap: 16, padding: "14px", background: "#f5f5f7", borderRadius: 14 }}>
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        <a href={`mailto:${p.email}`} style={{ fontSize: 12, color: "#1a8a3c", textDecoration: "none", fontWeight: 500 }}>{p.email}</a>
                      </div>
                    </div>
                  ))}
                  <a href="tel:+4972639199-0" style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "#424245", textDecoration: "none", paddingTop: 4 }}>
                    <svg width="13" height="13" fill="none" stroke="#1a8a3c" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
