...
export function TuringLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white overflow-x-hidden relative">
      ...
      {/* Main Content */}
      <main className="min-h-screen flex items-end pb-20 relative">
        {/* Hero Video Background */}
        <video
          className="absolute inset-0 w-full h-full object-cover z-0 bg-[#111]"
          autoPlay
          muted
          loop
          playsInline
        ...
        <div className="max-w-[1400px] mx-auto px-[60px] flex justify-between items-end relative z-[2]">
          {/* Left Content */}
